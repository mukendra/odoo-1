...
RUN apt-get install -y subversion git bzr bzrtools python-pip postgresql postgresql-server-dev-9.3 python-all-dev python-dev python-setuptools libxml2-dev libxslt1-dev libevent-dev libsasl2-dev libldap2-dev pkg-config libtiff5-dev libjpeg8-dev libjpeg-dev zlib1g-dev libfreetype6-dev liblcms2-dev liblcms2-utils libwebp-dev tcl8.6-dev tk8.6-dev python-tk libyaml-dev fontconfig
...
ADD cp /opt/odoo/debian/openerp-server.conf /etc/odoo-server.conf
...
RUN sed -i "s|addons_path = /usr/lib/python2.7/dist-packages/openerp/addons|addons_path = /opt/odoo/addonsg" odoo-server.conf
